...
MRR grew overall from $4,684 in January 2023 to $2,273,427 in December 2024, though the climb was not linear, several months saw a pullback before resuming growth the following month. Average MRR per account moved from $1,561 to $2,817, meaning growth came from both more accounts and higher spend per account.
